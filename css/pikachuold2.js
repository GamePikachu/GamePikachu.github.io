...
div.setNextLevel=function(){if(this.level==9){alert("Bạn đã hoàn thành tất cả 9 màn chơi! Thành tích bạn ghi được là:"+totalscore+" điểm");this.createBigGame();}else{this.level++;this.blood++;totalscore+=el.score+elTimebar.tmp;
/*alert(totalscore);*/
